...
module PolarData
  ...
  class PbRecoveryTimes < ::ProtocolBuffers::Message; end

  class PbRecoveryTimes < ::ProtocolBuffers::Message
    set_fully_qualified_name "polar_data.PbRecoveryTimes"

    required ::PbLocalDateTime, :start_of_times, 1
